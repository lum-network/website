...
export const LUM_EXPLORER = 'http://explorer.lum.network';
export const LUM_DFRACT = 'https://dfract.lum.network';
...
export const LUM_NETWORK_WHITEPAPER = 'https://whitepaper.lum.network';
